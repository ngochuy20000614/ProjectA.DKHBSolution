...
{
    public partial class WebsiteHocBongContext : DbContext
    {
        public WebsiteHocBongContext()
        {
        }

        public WebsiteHocBongContext(DbContextOptions<WebsiteHocBongContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Diem>(entity =>
            {
                ...
                entity.HasOne(d => d.IdHocKyNavigation)
                    ...
                    .HasConstraintName("FK_IDHOCKY_DIEM");

                entity.HasOne(d => d.IdSinhVienNavigation)
                    .WithMany()
                    .HasForeignKey(d => d.IdSinhVien)
                    .HasConstraintName("FK_IDSINHVIEN_DIEM");
            });
